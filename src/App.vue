<template>
   <!-- <HomeView> <div id="home"></div></HomeView> -->
        ...
        <div class="row align-items-center position-relative">
          ...
          <div class="col-lg-3 col-md-8 col-6">
            <div class="header-actions">
              <!-- <div id="demo">
                <img src="/assets/images/logo/Catmini.png">
              </div> -->
                ...
                <div class="header-cart-content">
                  ...
                  <div class="cart-product-wrapper">
                    ...
                    <div class="cart-product-inner p-b-20 m-b-20 border-bottom">
                      ...
                      <div class="single-cart-product">
                        <div class="cart-product-thumb">
                          <a href="single-product.html"><img src="/assets/images/header/header-cart/1.png"
                              alt="Cart Product"></a>
                        </div>
                    ...
                    <div class="cart-product-inner p-b-20 m-b-20 border-bottom">
                      ...
                      <div class="single-cart-product">
                        <div class="cart-product-thumb">
                          <a href="single-product.html"><img src="/assets/images/header/header-cart/2.png"
                              alt="Cart Product"></a>
                        </div>
                        <div class="cart-product-content">
